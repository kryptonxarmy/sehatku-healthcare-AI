...
function MainAfter({ formData }) {
  ...
  return (
    <>
      ...
      <div className="w-[95%] md:w-[80%] h-screen pt-5 flex flex-col gap-10 justify-center items-center relative">
        ...
        <div className="flex gap-4 w-full justify-center absolute right-[50%] top-[80%] translate-x-[50%] translate-y-[50%] z-20">
          ...
          <input type="text" placeholder="" className="input input-bordered input-info h-xl w-full max-w-xl tex-black shadow-md bg-[#00f7ff15] focus:bg-[#2a2d35] " />
          <button className="btn btn-active btn-accent shadow-md shadow-cyan-500/50">Ask</button>
        </div>
        {/* FORM ABSOLUTE END */}

        <div className="overflow-y-scroll overflow-x-visible scrollbar-none flex flex-col items-start gap-4" style={{ scrollbarWidth: "none", msOverflowStyle: "none", "&::-webkit-scrollbar": { display: "none" } }}>
          {/* ----------------- SUMBER --------- */}
